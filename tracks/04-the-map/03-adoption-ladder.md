...
### 1. Read the five levels (5 min)

| Level | Name | What it looks like | How you recognise it | What holds you back |
|---|---|---|---|---|
| 0 | Not yet | You do not use AI tools, or you tried once and stopped. | "I don't know where I would use it." | No access, no time, or no first task. |
| 1 | Asking | You use a chat assistant for answers, text and ideas. You copy results by hand. | You ask, it answers, you do the actual work. | You have not handed over a whole task yet. |
| 2 | Pairing | An agent or builder does the work while you watch and approve step by step. | You read every change before it lands. You cannot look away. | Low trust in the output, and no way to check it except watching. |
| 3 | Delegating with checks | You hand over a scoped task with a spec and a "done when" line, and come back to evidence. | You define the check before the work starts. You review results, not steps. | Writing good specs and checks takes practice. |
| 4 | Delegating whole tasks with verification | Whole tasks run with checks built in: tests, a review prompt, a second opinion. Sometimes several at once. | You steer by goals and only look closely at exceptions. | Choosing which work is safe to delegate, and keeping the bar for quality the same. |

### 2. What moves you up

| From | To | The move |
|---|---|---|
| 0 | 1 | Do one real task with a chat assistant this week. Small is fine. |
| 1 | 2 | Let a builder or agent do a whole small thing, like [your first build](../01-first-build/01-your-first-build.md), instead of copying answers. |
...
One move I will try before the next check:
Tasks where I am happy to stay on a lower level, and why:
```
...
- [ ] You placed yourself on a level with one real example as evidence.
- [ ] You named what holds you back, in your own words.
- [ ] You picked one concrete move for the next few weeks.
- [ ] The filled-in self-check is saved in a note with today's date, so you can repeat it later.
